    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          Behind each project is a story of problem-solving, technical challenges, and creative solutions. 
          </p >
          <p className="text-lg text-[#6c757d] max-w-2xl mx-auto mt-5">While I can't share everything publicly due to confidentiality agreements, I'm always excited to discuss the approaches I've taken and the impact these solutions have made. Drop me a line about what interests you most.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="I am interested to learn more about... "
